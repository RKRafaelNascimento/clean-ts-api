import { Encrypter, AddAccountModel, AccountModel, AddAccountRepository } from './add-db-account-protocols'
...
const makeSut = (): SutTypes => {
  ...
  const sut = new DbAddAcount(encrypterSub, addAccountRepositoryStub)
